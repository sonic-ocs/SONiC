...
![OCS Deployment](./images/ocs-deployment.png)
...
The following diagram shows the main changes and extension points of SONiC to support OCS devices:

![OCS Extension](./images/ocs-extensions.png)
...
![swss and syncd](./images/control-flow.png)
...
![Line Card syncd](./images/linecard-syncd.png)
